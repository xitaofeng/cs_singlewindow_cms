...
<div class="login-box">
    <div class="login-logo">
        <a href="${ctx}/" style="color:#fff;"><b>中国(长沙)国际贸易单一窗口</b>CMS</a>
    </div>
    <div class="login-box-body">
        ...
        <form id="validForm" action="/news/doLogin" method="post">
            <p id="errInfo" class="login-box-msg text-danger" style="display: none">
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control required" id="username" name="username" value="111" placeholder="用户名">
...
<script>
    $(function () {
        (function () {
            ...
            if(errMsg === 'username_or_password_error' ){
                $("#errInfo").show();
            }
        })();
